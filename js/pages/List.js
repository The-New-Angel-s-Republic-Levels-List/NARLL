    ...
    template: `
        ...
        <main v-else class="page-list">
            ...
            <div class="level-container">
                <div style="position: absolute; top: 10px; right: 10px; background: #fcbaf846; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold; z-index: 100; text-align: center; line-height: 1.2;">
